    ...
    groups: [
      ...
      },
      {
        ...
        rows: [
          ...
          ['Alt+클릭', '겹친 요소 하나 아래 선택 (계속 Alt+클릭하면 더 아래로)'],
          ['Ctrl+휠', '확대 · 축소'],
          ['방향키', '8px씩 이동'],
          ['Ctrl+방향키', '1px씩 미세 이동'],
          ['Alt+방향키', '크기 조절'],
    ...
    groups: [
      ...
      },
      {
        ...
        rows: [
          ...
          ['Ctrl+Shift+N', '본문 스타일'],
          ['Enter · Shift+Enter', '새 문단 · 같은 문단 안 줄바꿈'],
          ['Enter(목록 안)', '다음 항목 · 빈 항목에서 목록 나가기'],
    ...
    groups: [
      ...
      },
      {
        ...
        rows: [
          ...
          ['시트 탭 끌기', '시트 순서 변경 (여러 탭 선택 시 함께 이동)'],
          ['Ctrl+탭 클릭 · Shift+탭 클릭', '여러 시트 선택 · 구간 선택 — 편집이 모두에 적용'],
        ],
      },
    ],
  },
